...
<XColumn :column="column" :isStacked="isStacked" :refresher="reload">
	<template #header>
		...
		<span style="margin-left: 8px;">{{ i18n.ts._deck._columns.xForYouTimeline }}</span>
	</template>
...
const { tweets, likedIds, loading, error, bridgeError, fetchTimeline, reload, onLike } = useXTimeline('x/for-you', { sort: false });
