...
export type NonImageMuteCreateRequest = operations['non-image-mute___create']['requestBody']['content']['application/json'];
export type NonImageMuteDeleteRequest = operations['non-image-mute___delete']['requestBody']['content']['application/json'];
export type NonImageMuteListRequest = operations['non-image-mute___list']['requestBody']['content']['application/json'];
export type NonImageMuteListResponse = operations['non-image-mute___list']['responses']['200']['content']['application/json'];
...
export type XLikeRequest = operations['x___like']['requestBody']['content']['application/json'];
export type XUnlikeRequest = operations['x___unlike']['requestBody']['content']['application/json'];
